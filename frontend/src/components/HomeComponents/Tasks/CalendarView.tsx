...
const CalendarView: React.FC<CalendarViewProps> = ({ tasks, onTaskClick }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-[#060E20] text-gray-100">
      {/* Calendar Section */}
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    ...
                    {task.priority && (
                      ...
                      ${task.priority === 'M' ? 'bg-yellow-500/20 text-yellow-400' : ''}
                      ${task.priority === 'L' ? 'bg-green-500/20 text-green-400' : ''}
                    `}
                      >
