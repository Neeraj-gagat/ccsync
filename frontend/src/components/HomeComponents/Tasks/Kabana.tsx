...
function KanbanColumn({
  ...
  return (
    <div
      ...
      className={`flex flex-col min-w-[260px] max-w-[330px] h-[500px] rounded-2xl border-white/[0.07] border  transition-colors duration-200 bg-gradient-to-r from-[#060E20] to-[#060e23]
